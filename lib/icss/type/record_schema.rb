  ...
  module Meta
    ...
    class RecordSchema
      ...
      def self.receive(schema, default_superklass=Object)
        ...
        schema_obj.is_a = [default_superklass] if schema_obj.is_a.empty?
        #
        model_klass = Icss::Meta::NamedType.get_model_klass(schema_obj.fullname, schema_obj.parent_klass)
        #
