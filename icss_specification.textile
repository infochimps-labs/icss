...
* @request@     - an array of one element giving a hash suitable for populating the message's @request@ type (required).
* @response@    - a hash suitable for populating the message's @response@ type (optional).
* @url@         - Rather than supply the request params, you may supply them as a URL (optional).
